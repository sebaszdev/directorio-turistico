      ...
      <div className="grid grid-cols-3 grid-rows-2 gap-4 h-screen bg-muted">
        <div className="flex flex-col justify-evenly p-2">
          ...
          <p className="leading-7 text-center [&:not(:first-child)]:mt-6">
            Bogotá, capital de Colombia, es una ciudad vibrante ubicada en la
            cordillera de los Andes. Combina historia colonial, arte urbano y
            una vida cultural diversa. Su clima fresco y sus amplias ciclovías
            la hacen única. Es un centro económico, educativo y gastronómico del
            país.
          </p>
        </div>
        <div
        ...
        <div className="flex flex-wrap justify-evenly content-center col-span-2 full px-8">
          <Card className="grid grid-cols-2 w-xl">
            ...
            <CardContent>
              Una de las mejores cosas que hacer en Bogotá es subir al Cerro de
              Monserrate para disfrutar de las mejores vistas de la ciudad. Este
              cerro situado a 3.152 metros de altura, es el más famoso de los
              que rodean la ciudad, y el que todavía conserva gran parte del
              bosque andino.
            </CardContent>
          </Card>
          <Card className="grid grid-cols-2 w-xl">
            ...
            <CardContent>
              La enorme Plaza de Bolívar, situada en el corazón de casco
              antiguo, es la más importante que ver en Bogotá. Esta plaza, punto
              de encuentro entre turistas y locales, concentra alguno de los
              edificios más importantes de la ciudad como la Catedral Primada,
              el Palacio de Justicia, el Capitolio Nacional y el Palacio
              Liévano, sede del ayuntamiento.
            </CardContent>
          </Card>
        </div>
      </div>
