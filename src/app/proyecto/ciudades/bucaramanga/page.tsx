  ...
  return (
    <>
      <div className="grid grid-cols-3 h-screen">
        <div
          className="w-full h-full flex flex-col col-span-2 gap-y-4 pt-10
        ...
        >
          ...
          <div className="w-full max-w-3xl bg-muted opacity-85 rounded-lg p-4 mx-auto mt-4">
            <p className="leading-7 text-center [&:not(:first-child)]:mt-6">
              Bucaramanga, conocida como “La Ciudad Bonita”, es la capital del
              departamento de Santander en Colombia. Se destaca por su clima
              agradable, su ambiente tranquilo y su abundante oferta de parques
              y zonas verdes. Es un centro regional de comercio, educación y
              servicios, con una creciente vida cultural y gastronómica. Su
              cercanía al Cañón del Chicamocha la convierte también en un
              destino para actividades de aventura y ecoturismo.
            </p>
          </div>
        </div>
                ...
                <Card className="w-md opacity-85">
                  ...
                  <CardContent>
                    <p className="leading-7 text-center [&:not(:first-child)]:mt-6">
                      ...
                      panorámica de la ciudad y el mar Caribe. Es un lugar ideal
                      para aprender sobre la historia militar de la región y
                      explorar sus túneles subterráneos.
                    </p>
                  </CardContent>
                </Card>
              </CarouselItem>
